    ...
    <div {...props} className="flex-col items-center">
      ...
      <div className="container">
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="mt-4 md:ml-0 md:mt-0">
        ...
        <div className="flex flex-col items-center md:flex-row-reverse">
          ...
          <div className="mt-4 md:ml-0 md:mt-0">
            ...
            <p>
              Food Wastage is a global challenge, and we have to take firm
              actions to do our part for Singapore to reduce food wastage.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="mt-4 md:ml-0 md:mt-0">
            <p>
              What are you waiting for? Create an account now and join the
              community in combatting food wastage!
            </p>
            <a href="/register">
