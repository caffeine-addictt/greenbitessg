...
const TosPage: PageComponent = ({ className, ...props }) => (
  <div
    {...props}
    className={cn(
      className,
      'flex-col gap-10 my-10 *:flex *:flex-col *:gap-2 *:w-full *:md:w-1/2 *:mx-auto',
    )}
  >
    <div className="my-5 text-center">
      <h1 className="text-5xl font-bold">Terms of Service</h1>
      <p className="text-sm">Last updated: 2024-08-12</p>
    </div>

    <div>
      <h3 className="text-2xl font-bold">1. Introduction</h3>
      <p>Welcome to Greenbites SG (“Company”, “we”, “our”, “us”)!</p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at greenbitessg.ngjx.org (together or individually
        “Service”) operated by Greenbites SG.
      </p>
      <p>
      ...
      <p>
        ...
        support@greenbitessg.ngjx.org so we can try to find a solution. These
    ...
    <div>
      <h3 className="text-2xl font-bold">2. Communications</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">4. Content</h3>
      <p>
      ...
      <p>
        Greenbites SG has the right but not the obligation to monitor and edit
        all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Greenbites SG or used with permission. You may not distribute,
    ...
    <div>
      <h3 className="text-2xl font-bold">5. Prohibited Uses</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">6. Analytics</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">7. Accounts</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">8. Intellectual Property</h3>
      <p>
        ...
        Greenbites SG and its licensors. Service is protected by copyright,
        ...
        written consent of Greenbites SG.
      </p>
    </div>

    <div>
      <h3 className="text-2xl font-bold">9. Copyright Policy</h3>
      <p>
      ...
      <p>
        ...
        to support@greenbitessg.ngjx.org, with the subject line: “Copyright
    ...
    <div>
      <h3 className="text-2xl font-bold">11. Error Reporting and Feedback</h3>
      <p>
        You may provide us either directly at support@greenbitessg.ngjx.org or
    ...
    <div>
      <h3 className="text-2xl font-bold">12. Links To Other Web Sites</h3>
      <p>
        Our Service may contain links to third party web sites or services that
        are not owned or controlled by Greenbites SG.
      </p>
      <p>
        Greenbites SG has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        easy-to-use free tool for creating an excellent standard Terms of
    ...
    <div>
      <h3 className="text-2xl font-bold">13. Disclosure Of Warranty</h3>
      <p>
    ...
    <div>
      ...
      <p>
        ...
        of Singapore, which governing law applies to agreement without regard to
    ...
    <div>
      <h3 className="text-2xl font-bold">17. Changes To Service</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">18. Amendments To Terms</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">19. Waiver And Severability</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">20. Acknowledgement</h3>
      <p>
    ...
    <div>
      <h3 className="text-2xl font-bold">21. Contact Us</h3>
      <p>
        Please send your feedback, comments, requests for technical support by
        email: support@greenbitessg.ngjx.org.
      </p>
    </div>
  </div>
);
